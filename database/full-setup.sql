...
CREATE TABLE IF NOT EXISTS products (
  ...
  tier5_commission_rate DECIMAL(5,2) DEFAULT 2.00 CHECK (tier5_commission_rate >= 0 AND tier5_commission_rate <= 100),
  is_active BOOLEAN DEFAULT true,
  created_by UUID,
  updated_by UUID,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS campaigns (
  ...
  target_tier_levels INTEGER[] DEFAULT ARRAY[1,2,3,4,5],
...
CREATE TABLE IF NOT EXISTS commission_settings (
  ...
  tier4_from_tier5_bonus DECIMAL(5,2) DEFAULT 0.50,
